...
export const metadata: Metadata = {
  ...
  description: "Week 29 EU economic digest (2026-07-13 – 2026-07-19): GDP rankings, inflation trends, unemployment rates across EU member states. Data from Eurostat via Aethar APIs.",
...
export default function WeeklyReport() {
  return (
    <div>
      ...
      <p className="mt-3 text-sm text-[#8890AA]">2026-07-13 – 2026-07-19 · auto-generated from live Eurostat data via Aethar APIs.</p>

...
export const metadata: Metadata = {
  ...
  description: "Week 19 EU economic digest (2026-05-11 – 2026-05-17): GDP rankings, inflation trends, unemployment rates across EU member states. Data from Eurostat via Aethar APIs.",
...
export default function WeeklyReport() {
  return (
    <div>
      ...
      <p className="mt-3 text-sm text-[#8890AA]">2026-05-11 – 2026-05-17 · auto-generated from live Eurostat data via Aethar APIs.</p>

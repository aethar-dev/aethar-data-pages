...
export const metadata: Metadata = {
  title: "EU Economic Weekly — Week 19, May 2026",
  description: "Week 19 EU economic digest (2026-05-04 – 2026-05-10): GDP rankings, inflation trends, unemployment rates across EU member states. Data from Eurostat via Aethar APIs.",
  alternates: { canonical: "/reports/weekly-2026-w19" },
};

export default function WeeklyReport() {
  return (
    <div>
      <p className="text-xs font-semibold uppercase tracking-widest text-[#4DD0E1]">Weekly Data Report · Week 19</p>
      <h1 className="mt-2 text-2xl font-light text-white">EU Economic Weekly — Week 19, May 2026</h1>
      <p className="mt-3 text-sm text-[#8890AA]">2026-05-04 – 2026-05-10 · auto-generated from live Eurostat data via Aethar APIs.</p>
      ...
      <div className="mt-10">
        ...
        <table className="mt-4 w-full text-sm">
          ...
          <tbody>
              ...
              <tr key="AT" className="border-b border-[#2A2D3A]/50">
                <td className="py-2 pr-4 text-sm text-white">Austria</td>
                <td className="py-2 text-right font-mono text-sm text-[#4DD0E1]">99.8</td>
              </tr>
              <tr key="LT" className="border-b border-[#2A2D3A]/50">
                <td className="py-2 pr-4 text-sm text-white">Lithuania</td>
                <td className="py-2 text-right font-mono text-sm text-[#4DD0E1]">99.6</td>
              </tr>
              <tr key="FI" className="border-b border-[#2A2D3A]/50">
                <td className="py-2 pr-4 text-sm text-white">Finland</td>
                <td className="py-2 text-right font-mono text-sm text-[#4DD0E1]">99.5</td>
              </tr>
              ...
              <tr key="BG" className="border-b border-[#2A2D3A]/50">
                ...
                <td className="py-2 text-right font-mono text-sm text-[#4DD0E1]">99.4</td>
              </tr>
              <tr key="PL" className="border-b border-[#2A2D3A]/50">
                <td className="py-2 pr-4 text-sm text-white">Poland</td>
                <td className="py-2 text-right font-mono text-sm text-[#4DD0E1]">99.4</td>
              ...
              <tr key="DK" className="border-b border-[#2A2D3A]/50">
                <td className="py-2 pr-4 text-sm text-white">Denmark</td>
                <td className="py-2 text-right font-mono text-sm text-[#4DD0E1]">99.3</td>
              </tr>
              <tr key="SK" className="border-b border-[#2A2D3A]/50">
                <td className="py-2 pr-4 text-sm text-white">Slovakia</td>
                <td className="py-2 text-right font-mono text-sm text-[#4DD0E1]">99.2</td>
              </tr>
          </tbody>
        </table>
      </div>

...
export const metadata: Metadata = {
  title: "EU Economic Weekly — Week 38, September 2026",
  description: "Week 38 EU economic digest (2026-09-14 – 2026-09-20): GDP rankings, inflation trends, unemployment rates across EU member states. Data from Eurostat via Aethar APIs.",
  alternates: { canonical: "/reports/weekly-2026-w38" },
};

export default function WeeklyReport() {
  return (
    <div>
      <p className="text-xs font-semibold uppercase tracking-widest text-[#4DD0E1]">Weekly Data Report · Week 38</p>
      <h1 className="mt-2 text-2xl font-light text-white">EU Economic Weekly — Week 38, September 2026</h1>

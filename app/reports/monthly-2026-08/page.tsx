...
export const metadata: Metadata = {
  title: "EU Economic Monthly — August 2026",
  description: "August 2026 EU economic digest with year-over-year context: GDP top 10, inflation rankings, unemployment rates, and population trends across all 27 EU member states. Data from Eurostat via Aethar APIs.",
  alternates: { canonical: "/reports/monthly-2026-08" },
};
...
export default function MonthlyReport() {
  return (
    <div>
      ...
      <h1 className="mt-2 text-2xl font-light text-white">EU Economic Monthly — August 2026</h1>
      ...
      <div className="mt-10">
        ...
        <table className="mt-4 w-full text-sm">
          ...
          <tbody>
              ...
              <tr key="PL" className="border-b border-[#2A2D3A]/50">
                <td className="py-2 pr-4 text-sm text-white">Poland</td>
                <td className="py-2 text-right font-mono text-sm text-[#4DD0E1]">7.6%</td>
                <td className="py-2 pl-4 text-right font-mono text-xs">—</td>
              </tr>
              <tr key="SE" className="border-b border-[#2A2D3A]/50">
                <td className="py-2 pr-4 text-sm text-white">Sweden</td>

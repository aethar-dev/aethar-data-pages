...
export const metadata: Metadata = {
  ...
  description: "Week 20 EU economic digest (2026-05-11 – 2026-05-17): GDP rankings, inflation trends, unemployment rates across EU member states. Data from Eurostat via Aethar APIs.",
        ...
        <table className="mt-4 w-full text-sm">
          ...
          <tbody>
              ...
              <tr key="PT" className="border-b border-[#2A2D3A]/50">
                ...
                <td className="py-2 text-right font-mono text-sm text-[#4DD0E1]">99.9</td>
              </tr>
          </tbody>
        </table>
      </div>

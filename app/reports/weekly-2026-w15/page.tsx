...
export const metadata: Metadata = {
  ...
  description: "Weekly EU economic data digest: GDP rankings, inflation trends, unemployment rates across EU member states. April 2026.",
};
...
export default function WeeklyReport() {
  return (
    <div>
      ...
      <h1 className="mt-2 text-2xl font-light text-white">EU Economic Weekly — April 2026</h1>

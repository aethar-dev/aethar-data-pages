...
export const metadata: Metadata = {
  title: "EU Economic Monthly — September 2026",
  description: "September 2026 EU economic digest with year-over-year context: GDP top 10, inflation rankings, unemployment rates, and population trends across all 27 EU member states. Data from Eurostat via Aethar APIs.",
  alternates: { canonical: "/reports/monthly-2026-09" },
};
...
export default function MonthlyReport() {
  return (
    <div>
      ...
      <h1 className="mt-2 text-2xl font-light text-white">EU Economic Monthly — September 2026</h1>
        ...
        <table className="mt-4 w-full text-sm">
          ...
          <tbody>
              <tr key="DE" className="border-b border-[#2A2D3A]/50">
                ...
                <td className="py-2 pl-4 text-right font-mono text-xs">—</td>
              </tr>
      ...
      <div className="mt-10">
        ...
        <table className="mt-4 w-full text-sm">
          ...
          <tbody>
              ...
              <tr key="PL" className="border-b border-[#2A2D3A]/50">
                <td className="py-2 pr-4 text-sm text-white">Poland</td>
                <td className="py-2 text-right font-mono text-sm text-[#4DD0E1]">7.7%</td>
                <td className="py-2 pl-4 text-right font-mono text-xs">—</td>
              </tr>
              <tr key="SE" className="border-b border-[#2A2D3A]/50">
                <td className="py-2 pr-4 text-sm text-white">Sweden</td>
      ...
      <div className="mt-10">
        ...
        <table className="mt-4 w-full text-sm">
          ...
          <tbody>
              <tr key="DE" className="border-b border-[#2A2D3A]/50">
                <td className="py-2 pr-4 text-sm text-white">Germany</td>
                <td className="py-2 text-right font-mono text-sm text-[#4DD0E1]">83,118,501</td>
                <td className="py-2 pl-4 text-right font-mono text-xs"><span className="text-green-400">-0.1%</span></td>
              </tr>
              <tr key="FR" className="border-b border-[#2A2D3A]/50">
                <td className="py-2 pr-4 text-sm text-white">France</td>
                <td className="py-2 text-right font-mono text-sm text-[#4DD0E1]">68,277,210</td>
                <td className="py-2 pl-4 text-right font-mono text-xs"><span className="text-yellow-300">+0.3%</span></td>
              </tr>
              <tr key="IT" className="border-b border-[#2A2D3A]/50">
                <td className="py-2 pr-4 text-sm text-white">Italy</td>
                <td className="py-2 text-right font-mono text-sm text-[#4DD0E1]">58,997,201</td>
                <td className="py-2 pl-4 text-right font-mono text-xs"><span className="text-green-400">-0.1%</span></td>
              </tr>
              <tr key="ES" className="border-b border-[#2A2D3A]/50">
                <td className="py-2 pr-4 text-sm text-white">Spain</td>
                <td className="py-2 text-right font-mono text-sm text-[#4DD0E1]">48,085,361</td>
                <td className="py-2 pl-4 text-right font-mono text-xs"><span className="text-yellow-300">+1.3%</span></td>
              </tr>
              <tr key="PL" className="border-b border-[#2A2D3A]/50">
                <td className="py-2 pr-4 text-sm text-white">Poland</td>
                <td className="py-2 text-right font-mono text-sm text-[#4DD0E1]">36,753,736</td>
                <td className="py-2 pl-4 text-right font-mono text-xs"><span className="text-green-400">-0.4%</span></td>
              </tr>
              <tr key="RO" className="border-b border-[#2A2D3A]/50">
                <td className="py-2 pr-4 text-sm text-white">Romania</td>
                <td className="py-2 text-right font-mono text-sm text-[#4DD0E1]">19,055,228</td>
                <td className="py-2 pl-4 text-right font-mono text-xs"><span className="text-yellow-300">+0.1%</span></td>
              </tr>
              <tr key="NL" className="border-b border-[#2A2D3A]/50">
                <td className="py-2 pr-4 text-sm text-white">Netherlands</td>
                <td className="py-2 text-right font-mono text-sm text-[#4DD0E1]">17,811,291</td>
                <td className="py-2 pl-4 text-right font-mono text-xs"><span className="text-yellow-300">+1.3%</span></td>
              </tr>
              <tr key="BE" className="border-b border-[#2A2D3A]/50">
                <td className="py-2 pr-4 text-sm text-white">Belgium</td>
                <td className="py-2 text-right font-mono text-sm text-[#4DD0E1]">11,742,796</td>
                <td className="py-2 pl-4 text-right font-mono text-xs"><span className="text-yellow-300">+1.1%</span></td>
              </tr>
              <tr key="CZ" className="border-b border-[#2A2D3A]/50">
                <td className="py-2 pr-4 text-sm text-white">Czechia</td>
                <td className="py-2 text-right font-mono text-sm text-[#4DD0E1]">10,827,529</td>
                <td className="py-2 pl-4 text-right font-mono text-xs"><span className="text-yellow-300">+3.0%</span></td>
              </tr>
              <tr key="SE" className="border-b border-[#2A2D3A]/50">
                <td className="py-2 pr-4 text-sm text-white">Sweden</td>
                <td className="py-2 text-right font-mono text-sm text-[#4DD0E1]">10,521,556</td>

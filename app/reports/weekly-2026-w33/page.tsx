...
export const metadata: Metadata = {
  title: "EU Economic Weekly — Week 33, August 2026",
  description: "Week 33 EU economic digest (2026-08-10 – 2026-08-16): GDP rankings, inflation trends, unemployment rates across EU member states. Data from Eurostat via Aethar APIs.",
  alternates: { canonical: "/reports/weekly-2026-w33" },
};

export default function WeeklyReport() {
  return (
    <div>
      <p className="text-xs font-semibold uppercase tracking-widest text-[#4DD0E1]">Weekly Data Report · Week 33</p>
      <h1 className="mt-2 text-2xl font-light text-white">EU Economic Weekly — Week 33, August 2026</h1>
      <p className="mt-3 text-sm text-[#8890AA]">2026-08-10 – 2026-08-16 · auto-generated from live Eurostat data via Aethar APIs.</p>
        ...
        <table className="mt-4 w-full text-sm">
          ...
          <tbody>
              ...
              <tr key="IE" className="border-b border-[#2A2D3A]/50">
                ...
                <td className="py-2 text-right font-mono text-sm text-[#4DD0E1]">57,657</td>
              </tr>
              <tr key="FI" className="border-b border-[#2A2D3A]/50">
                <td className="py-2 pr-4 text-sm text-white">Finland</td>
                <td className="py-2 text-right font-mono text-sm text-[#4DD0E1]">47,078.5</td>
              </tr>
              <tr key="GR" className="border-b border-[#2A2D3A]/50">
                <td className="py-2 pr-4 text-sm text-white">Greece</td>
                <td className="py-2 text-right font-mono text-sm text-[#4DD0E1]">45,676.4</td>
              </tr>
          </tbody>
        </table>
      </div>
        ...
        <table className="mt-4 w-full text-sm">
          ...
          <tbody>
              ...
              <tr key="PL" className="border-b border-[#2A2D3A]/50">
                ...
                <td className="py-2 text-right font-mono text-sm text-red-400">7.7%</td>
              </tr>
              <tr key="SE" className="border-b border-[#2A2D3A]/50">
                <td className="py-2 pr-4 text-sm text-white">Sweden</td>
                <td className="py-2 text-right font-mono text-sm text-red-400">7.7%</td>

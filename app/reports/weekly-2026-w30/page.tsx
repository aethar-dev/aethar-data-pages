...
export const metadata: Metadata = {
  title: "EU Economic Weekly — Week 30, July 2026",
  description: "Week 30 EU economic digest (2026-07-20 – 2026-07-26): GDP rankings, inflation trends, unemployment rates across EU member states. Data from Eurostat via Aethar APIs.",
  alternates: { canonical: "/reports/weekly-2026-w30" },
};

export default function WeeklyReport() {
  return (
    <div>
      <p className="text-xs font-semibold uppercase tracking-widest text-[#4DD0E1]">Weekly Data Report · Week 30</p>
      <h1 className="mt-2 text-2xl font-light text-white">EU Economic Weekly — Week 30, July 2026</h1>

...
export const metadata: Metadata = {
  title: "EU Economic Weekly — Week 39, September 2026",
  description: "Week 39 EU economic digest (2026-09-21 – 2026-09-27): GDP rankings, inflation trends, unemployment rates across EU member states. Data from Eurostat via Aethar APIs.",
  alternates: { canonical: "/reports/weekly-2026-w39" },
};

export default function WeeklyReport() {
  return (
    <div>
      <p className="text-xs font-semibold uppercase tracking-widest text-[#4DD0E1]">Weekly Data Report · Week 39</p>
      <h1 className="mt-2 text-2xl font-light text-white">EU Economic Weekly — Week 39, September 2026</h1>
      <p className="mt-3 text-sm text-[#8890AA]">2026-09-21 – 2026-09-27 · auto-generated from live Eurostat data via Aethar APIs.</p>

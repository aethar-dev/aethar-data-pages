...
export const metadata: Metadata = {
  title: "EU Economic Weekly — Week 22, May 2026",
  description: "Week 22 EU economic digest (2026-05-25 – 2026-05-31): GDP rankings, inflation trends, unemployment rates across EU member states. Data from Eurostat via Aethar APIs.",
  alternates: { canonical: "/reports/weekly-2026-w22" },
};

export default function WeeklyReport() {
  return (
    <div>
      <p className="text-xs font-semibold uppercase tracking-widest text-[#4DD0E1]">Weekly Data Report · Week 22</p>
      <h1 className="mt-2 text-2xl font-light text-white">EU Economic Weekly — Week 22, May 2026</h1>
      <p className="mt-3 text-sm text-[#8890AA]">2026-05-25 – 2026-05-31 · auto-generated from live Eurostat data via Aethar APIs.</p>
        ...
        <table className="mt-4 w-full text-sm">
          ...
          <tbody>
              <tr key="MT" className="border-b border-[#2A2D3A]/50">
                ...
                <td className="py-2 text-right font-mono text-sm text-[#4DD0E1]">101.8</td>
              </tr>
